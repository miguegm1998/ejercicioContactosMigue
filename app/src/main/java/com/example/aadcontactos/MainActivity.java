...
import com.example.aadcontactos.settings.SettingsActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean checkPermissionsWritePrivate(){
        if(ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED){
            Toast toast= Toast.makeText(getApplicationContext(),"Tienes que aceptar los permisos"
                    ,Toast.LENGTH_LONG);
            return false;
        }else {
            return true;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            case R.id.action_settings:
                ...
                startActivity(i);
                break;
            case R.id.guardar_fichero:
                i = new Intent(MainActivity.this, guardar.class);
                startActivity(i);
                break;
            case R.id.leer_fichero:
                i = new Intent(MainActivity.this, Leer.class);
                startActivity(i);
                break;
        }
